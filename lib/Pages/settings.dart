...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> handleNotificationsToggle(bool val) async {
    ...
    // Extend: integrate push notification subscribe/unsubscribe here
  }

  /// Theme selection dialog with icons and beautiful UI
  ...
  Widget _themeOptionTile({
    ...
    return ListTile(
      ...
      selected: selected,
      selectedTileColor: color.withValues(alpha: .1),
    );
  }
      ...
      child: Row(
        ...
        children: [
          ...
          CupertinoSwitch(
            value: value,
            onChanged: onChanged,
            activeColor: theme.colorScheme.primary, // highlight only here
          ),
        ],
      ),
    );
